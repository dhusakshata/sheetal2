 ...
 <div className="footer-newsletter">
      ...
      <p style={{marginLeft:"20px"}}>(INDIA)</p>
        ...
        <span className="contact-1"> <a href="tel:+ 91 -20 -27130244 " className="Contact-item">
                      <FaPhoneAlt className="icon"style={{color:"#ffc107" }} />  +91 -20 -27130244
                     </a></span>
                     <span className="contact-2"> <a href="tel:+91 -20 -27130794 " className="Contact-item" style={{marginLeft:"35px"}}>
                    +91 -20 -27130794
                     </a></span>
  ...
  <p>
    <div className="footer-bottom">
      <div className="footer-left">
        &copy; 2025 Sheetal Rubber Products (P) Ltd. - All rights reserved   
        {/*  | Designed by <a href="https://bitshine.in/" className="bitshine-link" target="_blank" rel="noopener noreferrer"style={{ margin: "5px", color: "white" }}>
          Bitshine Infotech
        </a> */}
      </div>
